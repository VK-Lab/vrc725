...
export interface MelemInstallerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
...
export interface MelemInstaller extends BaseContract {
  connect(runner?: ContractRunner | null): MelemInstaller;
  waitForDeployment(): Promise<this>;

  interface: MelemInstallerInterface;
