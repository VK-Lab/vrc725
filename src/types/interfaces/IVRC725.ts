...
export interface IVRC725Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "approve"
...
export interface IVRC725 extends BaseContract {
  connect(runner?: ContractRunner | null): IVRC725;
  waitForDeployment(): Promise<this>;

  interface: IVRC725Interface;
